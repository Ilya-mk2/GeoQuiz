...
class CheatActivity : AppCompatActivity() {
    ...
    private lateinit var showAnserButton: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_cheat)

        answerTextView = findViewById(R.id.anwer_text_view)
        showAnserButton = findViewById(R.id.show_answer_button)
        answerIsTrue = intent.getBooleanExtra(EXTRA_ANSWER_IS_TRUE, false)

        showAnserButton.setOnClickListener{
            val answerText = when{
    ...
    override fun onSaveInstanceState(savedState: Bundle) {
        ...
        savedState.putBoolean(CHEAT_INDEX, quizViewModel.isCheater)
    }
